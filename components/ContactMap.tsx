      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
          <div className="w-full lg:w-1/3 space-y-8">
            ...
            >
              ...
              <p className="text-white/60 text-lg leading-relaxed font-medium">
                Centrally located in Kozhikode, our campus is designed for deep learning, collaboration, and technical excellence.
              </p>
            </motion.div>
          ...
          >
            ...
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3913.111956557458!2d75.7876!3d11.2588!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTHCsDE1JzMxLjciTiA3NcKwNDcnMTUuNCJF!5e0!3m2!1sen!2sin!4v1620000000000!5m2!1sen!2sin" 
              width="100%" 
              height="100%" 
